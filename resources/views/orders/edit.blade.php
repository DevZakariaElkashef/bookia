    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('orders.edit', $order->id) }}">{{ __('edit order') }}</a></span>
            </div>
        </div>
                        ...
                        <div id="wizard1">
                            ...
                            <section>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        <label class="form-label">{{ __('description') }}(AR): <span
                                                class="tx-danger">*</span></label>
                                        <textarea class="form-control" name="description_ar" required=""> {{ old('description_ar', $order->description_ar) }} </textarea>
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        <label class="form-label">{{ __('description') }}(EN): <span
                                                class="tx-danger">*</span></label>
                                        <textarea class="form-control" name="description_en" required=""> {{ old('description_en', $order->description_en) }} </textarea>
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        ...
                                        <input class="form-control" type="number" name="price"
                                            placeholder="{{ __('enter_price') }}" type="price"
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        ...
                                        <input class="form-control" type="number" name="offer"
                                            placeholder="{{ __('enter offer') }}" type="offer"
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        <label class="form-label">{{ __('start offer date') }}:</label>
                                        <input class="form-control" type="date" name="start_offer_date"
                                            placeholder="{{ __('enter start offer date') }}" type="start_offer_date"
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        <label class="form-label">{{ __('end offer date') }}:</label>
                                        <input class="form-control" type="date" name="end_offer_date"
                                            placeholder="{{ __('enter end_offer date') }}" type="end_offer_date"
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        <label class="form-label">{{ __('inventory') }}: <span
                                            class="tx-danger">*</span></label>
                                        <input class="form-control" type="number" name="qty"
                                            placeholder="{{ __('enter_qty') }}" type="qty"
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        <label class="form-label">{{ __('section') }}: <span
                                            class="tx-danger">*</span></label>
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        <label class="form-label">{{ __('store') }}: <span
                                            class="tx-danger">*</span></label>
                                ...
                                <div class="attibutes">
                                    @foreach ($order->attributes as $orderAttribute)
                                        <div class="attribute row align-items-center">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="option">{{ __('options') }}</label>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="price">{{ __('additional price') }}</label>
                            ...
                            <h3>{{ __('order_images') }}</h3>
                            <section>
                                <div class="row">
                                    <div class="col-md-12 form-group mt-4">
                                        <div class="custom-file">
                                            <label class="custom-file-label"
                                                for="customFile">{{ __('image') }}</label>
                                    ...
                                    <div class="col-md-12 form-group mt-4">
                                        <div class="custom-file">
                                            <label class="custom-file-label"
                                                for="customFileMulti">{{ __('sliders') }}</label>
...
@section('js')
    ...
    @include('orders._dynamic_selector')
