    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <a class="text-dark"
                        href="{{ route('orders.create') }}">{{ __('create order') }}</a></span>
            </div>
        </div>
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                ...
                <form id="createOrderForm" method="post" action="{{ route('orders.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        <label class="form-label">{{ __('description') }}(AR): <span
                                                class="tx-danger">*</span></label>
                                        <textarea class="form-control" name="description_ar" placeholder="{{ __('enter_description') }}" required=""> {{ old('description_ar') }} </textarea>
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        <label class="form-label">{{ __('description') }}(EN): <span
                                                class="tx-danger">*</span></label>
                                        <textarea class="form-control" name="description_en" placeholder="{{ __('enter_description') }}" required=""> {{ old('description_en') }} </textarea>
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        ...
                                        <input class="form-control" type="number" name="offer"
                                            placeholder="{{ __('enter_offer') }}" type="offer"
                                            value="{{ old('offer') }}">
                                        @error('offer')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        <label class="form-label">{{ __('start_offer_date') }}:</label>
                                        <input class="form-control" type="date" name="start_offer_date"
                                            placeholder="{{ __('enter_start_offer_date') }}" type="start_offer_date"
                                    ...
                                    <div class="col-md-6 form-group mg-b-0">
                                        <label class="form-label">{{ __('end_offer_date') }}:</label>
                                        <input class="form-control" type="date" name="end_offer_date"
                                            placeholder="{{ __('enter_end_offer_date') }}" type="end_offer_date"
                            ...
                            <section>
                                <div class="attibutes">
                                    <div class="attribute row align-items-center">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="price">{{ __('additional_price') }}</label>
                            ...
                            <section>
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group mt-4">
                                        <div class="custom-file">
                                            <label class="custom-file-label"
                                                for="customFileMulti">{{ __('images') }}</label>
