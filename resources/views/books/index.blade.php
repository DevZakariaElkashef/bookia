...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('books.index') }}" class="btn btn-warning  btn-icon ml-2"><i
                        class="mdi mdi-refresh"></i></a>
            </div>
            <div class="mb-3 mb-xl-0">
                <a href="{{ route('books.create') }}" class="btn btn-primary ">{{ __('create') }}</a>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="#" class="btn btn-danger mx-1 d-none" id="deleteSelectionBtn"
                                ...
                                data-url="{{ route('books.delete') }}">{{ __('delete') }}</a>

                            <input type="text" id="searchInput" data-url="{{ route('books.search') }}"
                            ...
                            <div class="custom-select-wrapper mx-1">
                                <select id="showPerPage" class="custom-select"
                                    data-url="{{ route('books.index') }}" onchange="updatePageSize()">
